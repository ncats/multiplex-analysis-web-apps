    ...
    if 'phenocluster__clustering_adata' in st.session_state:
            ...
            with phenocluster__col1:
                ...
                if st.session_state['phenocluster__cluster_method'] == "phenograph":
                    st.selectbox('Phenograph clustering algorithm:', ['leiden', 'louvain'], key='phenocluster__phenograph_clustering_algo')
                ...
                if key in st.session_state:
                    ...
                    st.session_state['phenocluster__clustering_adata'] = result["adata_result"]
                    st.success(f"Clustering completed in {result['duration']:.2f} seconds!")
                ...
                if st.session_state['phenocluster__cluster_method'] in ["phenograph", "scanpy"]:
                    ...
                    if st.button('Run Clustering'):
                        start_time = time.time()
                        if st.session_state['phenocluster__cluster_method'] == "parc":
