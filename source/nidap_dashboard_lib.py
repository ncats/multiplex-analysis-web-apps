...
def init_session_state(session_state):
    ...
    session_state.OutputCSVPaths_U = os.path.join(framework_utils.session_dir(), 'output')
...
def reset_neigh_profile_settings(session_state):
    ...
    session_state.checkpoint_dir = os.path.join(framework_utils.session_dir(), 'output', 'checkpoints', 'neighborhood_profiles')
...
def save_csv(df, df_name):
    ...
    output_folder = os.path.join(framework_utils.session_dir(), 'output')
